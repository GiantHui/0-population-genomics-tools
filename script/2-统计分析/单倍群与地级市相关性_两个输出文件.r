...
# 加载数据
data <- read.csv("C:/Users/LuzHu/Desktop/M7b1a1.csv", header = TRUE, row.names = 1)
...
# ========== 输出第一个PDF：Frequency vs Latitude ==========
pdf("C:/Users/LuzHu/Desktop/output_Lat.pdf")
...
# ========== 输出第二个PDF：Frequency vs Longitude ==========
pdf("C:/Users/LuzHu/Desktop/output_Long.pdf")
