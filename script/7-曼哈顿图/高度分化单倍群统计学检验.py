...
# 读取数据
data = pd.read_csv('C:/Users/LuzHu/Desktop/Haplogroup_counts.txt', sep='\t')

# 从Category_totals.txt中读取总和数据
category_totals = pd.read_csv('C:/Users/LuzHu/Desktop/Category_totals.txt', sep='\t', header=None, index_col=0)
...
# 保存结果至桌面的TXT文件
output_path = 'C:/Users/LuzHu/Desktop/北汉南方少_result.txt'
